...
export const RichTextComponents = {
  ...
  h1: ({ children, ...props }: ComponentPropsWithoutRef<"h1">) => {
    return (
      <h1 className="mt-6 mb-6 text-4xl font-bold text-center" style={{ color: "var(--accent)" }} {...props}>
        {children}
      </h1>
    )
  },
  h2: ({ children, ...props }: ComponentPropsWithoutRef<"h2">) => {
    return (
      <h2 className="mt-4 mb-4 text-3xl font-bold text-black" {...props}>
        {children}
      </h2>
    )
  },
  ...
  blockquote: ({ children, ...props }: ComponentPropsWithoutRef<"blockquote">) => {
    return (
      <blockquote className="my-8 text-gray-600 italic border-l-8 border-gray-300 pl-5" {...props}>
        {children}
      </blockquote>
    )
  },
  ...
  img: ({ src, alt, ...props }: ComponentPropsWithoutRef<"img">) => {
    return <img src={src} alt={alt} className="my-6 mx-auto max-w-sm rounded-lg" {...props} />
  },
}
