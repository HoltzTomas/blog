...
export default function Home() {
  return (
    <div className="overflow-y-scroll px-[16px] md:px-[53px]">
      <div className="flex flex-col pb-[2rem] h-[85vh]">
        <h1 className={`mt-10 md:mt-20 text-center align-center text-[48px] md:text-[5rem] ${NeueMachinaUltraBold.className}`}>TOMAS HOLTZ</h1>
        <p className={`mt-[41px] text-[18px] text-center align-center ${NeueMachinaRegular.className}`}>Esto podria haber sido una cuenta de medium, pero bueno.</p>
        ...
        <div className="md:hidden bg-blue mt-auto mx-[-16px] py-8" >
