...
export interface AuthorsItem {
    ...
    name: Scalars['String']
    twitterHandle: (Scalars['String'] | null)
    website: (Scalars['String'] | null)
    __typename: 'AuthorsItem'
}

export type AuthorsItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'avatar__ASC' | 'avatar__DESC' | 'bio__ASC' | 'bio__DESC' | 'name__ASC' | 'name__DESC' | 'twitterHandle__ASC' | 'twitterHandle__DESC' | 'website__ASC' | 'website__DESC'
...
export type BlockDocument = (Authors | AuthorsItem | Posts | PostsItem | _AgentStart | authorsItem_AsList | postsItem_AsList) & { __isUnion?: true }
