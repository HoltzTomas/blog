  ...
  return (
    <div className="px-[16px] md:px-[53px] flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <div>
          <p className={`mt-[41px] text-[18px] text-center align-center ${NeueMachinaRegular.className}`}>22yo. <a href='https://www.itba.edu.ar/' rel="noopener noreferrer" target="_blank" >Computer Science & Engineering @ITBA</a></p>
