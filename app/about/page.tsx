            ...
            <div className="space-y-16">
                ...
                <div className={`space-y-8 ${NeueMachinaRegular.className}`}>
                    ...
                    <div className="space-y-6 text-lg">
                        ...
                        <p>
                            Y también en 2022 me asocié con <Link href="https://beacons.ai/josihuguet" target="_blank" rel="noopener noreferrer"><span className={`${NeueMachinaUltraBold.className} text-blue`}>Josi Huguet</span></Link> (Founder <Link href="https://hoopshoes.net/" target="_blank" rel="noopener noreferrer"><span className={`${NeueMachinaUltraBold.className} text-blue`}>Hoop Shoes</span></Link>) y <Link href="https://www.instagram.com/coco.gb4/" target="_blank" rel="noopener noreferrer"><span className={`${NeueMachinaUltraBold.className} text-blue`}>Matías Gallo</span></Link> (<Link href="https://www.instagram.com/flowgamebasketball/" target="_blank" rel="noopener noreferrer"><span className={`${NeueMachinaUltraBold.className} text-blue`}>Flow Game Basketball</span></Link>) para crear una plataforma para jugadores de básquet, pero el proyecto duró un mes porque mi cabeza no toleró hacer esto mientras trabajaba.
                        </p>
